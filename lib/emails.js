...
const UPLOAD_SLOT_ORDER = ['ingredients', 'additional', 'artwork']
const UPLOAD_SLOT_KEY = { ingredients: 'upload_cat_ingredients', additional: 'upload_cat_additional', artwork: 'upload_cat_artwork' }
...
function productionRows(order, t) {
  const rows = [
    [t.f_ean, order.ean],
    [t.f_pantmaerke, order.pantmaerke ? t.rv_yes : t.rv_no],
  ]
