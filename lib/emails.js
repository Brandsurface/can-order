...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#0e0a00;background:linear-gradient(160deg,#2a2820 0%,#0e0a00 55%);">
  <tr><td align="center" style="padding:44px 16px;">
    <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
      ...
      <tr><td style="padding-bottom:24px;">
        <p style="margin:0 0 18px;font-size:14px;color:#b8b4ae;line-height:1.6;">
          Click <strong style="color:#f1562e;">Approve</strong> to send the order to Brandsurface, or <strong style="color:#f87171;">Cancel</strong> to go back and make changes.
        </p>
        <table role="presentation" cellpadding="0" cellspacing="0">
          <tr>
            <td style="padding-right:10px;">
              <a href="${confirmUrl}"
                 style="display:inline-block;padding:14px 30px;background:#f1562e;color:#ffffff;font-size:15px;font-weight:700;text-decoration:none;border-radius:999px;letter-spacing:-0.01em;">
                Approve order
              </a>
            </td>
            <td>
              <a href="${cancelUrl}"
                 style="display:inline-block;padding:13px 26px;background:#242220;color:#f0ede8;font-size:14px;font-weight:500;text-decoration:none;border-radius:999px;border:1px solid #4a4640;">
                Cancel &amp; edit
              </a>
            </td>
          </tr>
